...
class GWR_Rental_Terms_Admin {
	...
	private static function field_label( $key ) {
		$labels = array(
			'id' => 'ID interno', 'title' => 'Titolo', 'intro' => 'Testo introduttivo', 'rental_name' => 'Nome commerciale noleggiatore', 'currency' => 'Valuta', 'taxes' => 'Tasse', 'terms_url' => 'Link condizioni complete', 'general_note' => 'Nota generale', 'updated_at' => 'Ultimo aggiornamento',
			...
			'min_age' => 'Eta minima', 'max_age' => 'Eta massima', 'min_license_years' => 'Anni minimi patente', 'international_license' => 'Patente internazionale richiesta', 'eu_license' => 'Patente UE richiesta', 'young_driver_surcharge' => 'Supplemento giovane conducente', 'senior_driver_surcharge' => 'Supplemento senior', 'surcharge_cost' => 'Costo supplemento', 'surcharge_mode' => 'Modalita supplemento', 'main_driver_required' => 'Conducente principale richiesto', 'additional_drivers' => 'Conducenti aggiuntivi ammessi', 'max_drivers' => 'Numero massimo conducenti',
